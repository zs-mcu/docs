...
<img src="./images/image-20240118231600047.png" alt="image-20240118231600047" style="zoom:50%;" />
...
2) 在内存中动态构建子类，注意<font color=red>代理的类不能为 final</font>，否则报错`java.lang.IllegalArgumentException:`
